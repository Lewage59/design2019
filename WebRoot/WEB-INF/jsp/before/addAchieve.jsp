	...
	<body>
		...
		<div class="tyle-content">
			<div class="container">
				<nav class="navbar navbar-default">
			      <div class="container-fluid">
			        <div class="navbar-header">
			          ...
			          <a class="navbar-brand" href="javascript:;">申请获奖成果</a>
			        </div>
				...
				<form:form action="/design2019/AchieveRegister" class="layui-form" method="post" modelAttribute="Achievements" enctype="multipart/form-data">	
				  <div class="layui-form-item">
				    <label class="layui-form-label">获奖名称</label>
				    <div class="layui-input-block">
				      <input type="text" name="aName" lay-verify="title" autocomplete="off" placeholder="请输入获奖名称" class="layui-input">
				    </div>
				  </div>
				  <div class="layui-form-item">
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input id="workfile" name="Acertificate" type="file">
				    </div>
				  </div>
