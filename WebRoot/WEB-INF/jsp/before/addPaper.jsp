	...
	<body>
		...
		<div class="tyle-content">
			<div class="container">
				<nav class="navbar navbar-default">
			      <div class="container-fluid">
			        <div class="navbar-header">
			          ...
			          <a class="navbar-brand" href="javascript:;">申请论文</a>
			        </div>
				...
				<form:form action="/design2019/PaperRegister" class="layui-form" method="post" modelAttribute="Paper" enctype="multipart/form-data">	
				  <div class="layui-form-item">
				    <label class="layui-form-label">题目</label>
				    <div class="layui-input-block">
				      <input type="text" name="subject" lay-verify="title" autocomplete="off" placeholder="请输入论文题目" class="layui-input">
				    </div>
				  </div>
				  <div class="layui-form-item">
				  ...
				  <div class="layui-form-item">
				    <label class="layui-form-label">杂志名称</label>
				    <div class="layui-input-block">
				      <input type="text" name="magazineName" lay-verify="required" placeholder="请输入杂志名称" autocomplete="off" class="layui-input">
				    </div>
				  </div>
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-inline">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="edition" lay-verify="publicNum" autocomplete="off" class="layui-input">
				      </div>
				    </div>
				  </div>
				  ...
				  <div class="layui-form-item">
				  	<div class="layui-inline">
					    ...
					    <div class="layui-input-block">
					      	<input id="coverImage" name="pcover" type="file" size="30">					
					    </div>
				    </div>
				    <div class="layui-inline">
					    <label class="layui-form-label">上传目录</label>
					    <div class="layui-input-block">
					      	<input id="catalogImage" name="pcatalog" type="file">					
					    </div>
				    </div>
				  </div>
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input id="workfile" name="ptext" type="file">
				    </div>
				  </div>
