	...
	<body>
		...
		<div class="tyle-content">
			<div class="container">
				<nav class="navbar navbar-default">
			      <div class="container-fluid">
			        <div class="navbar-header">
			          ...
			          <a class="navbar-brand" href="javascript:;">申请专利</a>
			        </div>
				...
				<form:form action="/design2019/PatentRegister" class="layui-form" method="post" modelAttribute="Patent" enctype="multipart/form-data">	
				  <div class="layui-form-item">
				    <label class="layui-form-label">专利名称</label>
				    <div class="layui-input-block">
				      <input type="text" name="pName" lay-verify="title" autocomplete="off" placeholder="请输入专利名称" class="layui-input">
				    </div>
				  </div>
				  <div class="layui-form-item">
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input id="workfile" name="Pcertificate" type="file">
				    </div>
				  </div>
